        ...
        <>
            <div className=" py-8" id="Speakers">
                ...
                <div className="w-full ">
                    <div className="my-6">
                        <div className="w-fit mx-auto bg-white text-lightbgblue text-xl px-10 sm:px-20 lg:px-28 py-1 rounded-3xl opacity-70">Guest Speaker</div>
                    ...
                    <div>
                        <div className="w-fit mx-auto bg-white text-lightbgblue text-xl px-10 sm:px-20 lg:px-28 py-1 rounded-3xl opacity-70">Other Speaker's</div>
                        <section className="max-w-full mx-auto px-4 sm:px-6 lg:px-4  py-8">
