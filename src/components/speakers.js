...
export function SpeakerCard(props) {
    return (
        <a href={`#workshop${props.id}`}>
            <div className="max-w-sm border-[1px] border-sky-600 hover:bg-slate-100  hover:bg-opacity-20 rounded-sm hover:rounded-none my-1 mx-1 w-80 sm:w-64  transition-all duration-1000 hover:shadow-lg to-[#56beffad] from-[#1ca2fc] via-[#168edd]  bg-gradient-to-tl shadow-md shadow-black hover:shadow-gray-700 group flex flex-col justify-around">
