import { InstagramSvg, FacebookSvg } from "./constants"
        ...
        <div className="from-darkbgblue to-blue-900 bg-gradient-to-b flex justify-center">
            <footer className="text-center text-white bg-black bg-blend-hue bg-opacity-60 w-full flex justify-center pt-5">
                <div className="container px-12 pt-6">
                    <div className="container h-[40rem] md:h-[32rem] pb-6 mx-auto flex flex-nowrap flex-col md:flex-row">

                        <div className="w-full h-[30rem] md:h-auto mt-8  opacity-70 hover:opacity-100 transition-opacity duration-500 rounded-lg overflow-hidden p-1 flex relative from-[#0a3a60] to-[#0b2244] bg-gradient-to-t ">
                            <iframe title="google map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3926.3671449790004!2d76.40663386471358!3d10.23194389269231!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b08068aa17bd247%3A0xf048b9ebcbd2af28!2sFederal%20Institute%20of%20Science%20And%20Technology%20(FISAT)%C2%AE!5e0!3m2!1sen!2sin!4v1643976276450!5m2!1sen!2sin" width="100%" height="100%" frameBorder="0" loading="lazy" style={{ filter: "invert(90%)" }}></iframe>
                    ...
                    <div className="max-w-3xl mx-auto mt-6">
                        ...
                        <div className="text-center text-xs md:text-sm bg container px-6 mt-3 py-4 font-sans w-full">
                            Created & designed
                            <a className="bg-yellow-300 bg-opacity-10 hover:bg-opacity-70" href="https://www.linkedin.com/in/amarjith-raj-b2822a196" target="_blank" rel="noreferrer"> Amarjith Raj , </a>
                            <a className="bg-yellow-300 bg-opacity-10 hover:bg-opacity-70" href="https://www.linkedin.com/in/aparna-joshi-9b8a89225" target="_blank" rel="noreferrer"> Aparna Joshi , </a>
                            <a className="bg-yellow-300 bg-opacity-10 hover:bg-opacity-70" href="https://www.linkedin.com/in/ashmi-subramanian-09078822a" target="_blank" rel="noreferrer"> Ashmi Subramanian  </a> &amp;
                            <a className="bg-yellow-300 bg-opacity-10 hover:bg-opacity-70" href="https://www.linkedin.com/in/joel-nickson-0a27721a5/" target="_blank" rel="noreferrer"> Joel Nickson </a>
                            <br></br>
                            <div className="my-6">
