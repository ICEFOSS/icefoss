...
export function AboutEachSection(props) {
    ...
    return (
        <div className="max-w-sm overflow-hidden  flex flex-col justify-start from-lightbgblue to-[#2288c7] bg-gradient-to-t rounded-lg shadow-xl hover:shadow-xl group">
            <div className='group-hover:-translate-y-1 transform from-lightbgblue to-[#118cc1] bg-gradient-to-b  group-hover:bg-opacity-5 shadow-sm group-hover:shadow-lg group-hover:shadow-sky-700 shadow-sky-900  rounded-lg transition-all duration-100 w-full mx-auto border-[1px] border-sky-600'>
