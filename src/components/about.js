...
export function AboutEachSection(props) {
    ...
    return (
        <div className="max-w-xs overflow-hidden  flex flex-col justify-start from-lightbgblue to-[#2288c7] bg-gradient-to-t rounded-lg shadow-xl hover:shadow-xl group">
